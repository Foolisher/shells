...
安利了一堆单测的重要性和方法论，那么接下来安利一个炫酷的单测框架 **Spock** ：

## Spock

因为，它可以运行在JUnit上，还拥有TestNG的参数化测试特性，却没有它那么繁琐；它能做到其他任何java mock框架能做到的mock，而且借助groovy的语法特性使代码更加简洁干练；对代码质量，对测试用例编写效率，对代码有洁癖最求的你值得拥有！
