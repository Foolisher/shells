...
以前都是OOP的思想下编程模型，一切都是面向对象，但某一天发现许多对象有相同的代码逻辑或片段，他们都是做同样的事，这样，第一是觉得这样的代码对于有洁癖的人看起来是很反感的，再者若这些代码涉及改动时所有用到的点都要改。但又发现这些需要植入的地方只是一些关键地方，那么，是否有一种方法使这些方法执行前或后再做点什么呢。方法是有的，目前比如有字节码操作、代理技术等来实现
